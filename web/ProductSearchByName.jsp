...
<div style="padding-top: 100px">
    <div class="container">
        <div class="contain-btn">
            ...
            <a href="<%=UtilsPath.getPath("productSeachByCategory?type="+type.get(typeItem))%>">
        ...
        <ul class="row " style="background-color: white;padding: 10px;">
            <%
                ArrayList<ProductModel> list = (ArrayList<ProductModel>) request.getAttribute("searchByName");
            ...
            <div class="col-md-3 one-product-list">
               ...
               <a href="http://localhost:8080/ProjectWeb_1920/AddCart?id=<%=list.get(i).getId()%>&search=<%=request.getParameter("search")%>&path=<%=request.getServletPath()%>&page=<%=page1%>"><div class="btn btn-cart-now"><i class="fas fa-shopping-cart"></i></div></a>
        ...
        <div style="max-width: 228px;margin: 0px auto;">
            <nav aria-label="Page navigation example ">
                <ul class="pagination">
                    ...
                    %>
                    <li class="page-item"><a class="page-link" id="active<%=pageNumber+1%>" href="<%=UtilsPath.getPath("SearchByName?search="+request.getParameter("search")+"&page="+listNumber.get(pageNumber))%>"><%=listNumber.get(pageNumber)%>
                    </a></li>
                    <%
                        }
                    %>
