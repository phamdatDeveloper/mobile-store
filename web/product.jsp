...
<div style="padding-top: 100px">
    <div class="container">
        ...
        <ul class="row " style="padding: 10px; background-color: white;">
            <%
                ArrayList<ProductModel> list = (ArrayList<ProductModel>) request.getAttribute("product");
            ...
            <div class="col-md-3 one-product-list">
                ...
                %>
                <a href="http://localhost:8080/ProjectWeb_1920/AddCart?id=<%=list.get(i).getId()%>&path=<%=request.getServletPath()%>&page=<%=page1%>"> <div class="btn btn-cart-now"><i class="fas fa-shopping-cart"></i></div></a>
        ...
        <div style="max-width: 228px;margin: 0px auto;">
            <nav aria-label="Page navigation example ">
                <ul class="pagination">
                    ...
                    %>
                    <li class="page-item"><a class="page-link" id="active<%=pageNumber+1%>" href="<%=UtilsPath.getPath("ListProduct?page="+listNumber.get(pageNumber))%>"><%=listNumber.get(pageNumber)%>
                    </a></li>
                    <%
                        }
                    %>
